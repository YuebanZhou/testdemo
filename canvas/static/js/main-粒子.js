...
function resize(){
  canvas.width=window.innerWidth||document.getElement.clientWidth||document.body.clientWidth;
  canvas.height=(window.innerHeight||document.getElement.clientHeight||document.body.clientHeight)-200;
}
//获取鼠标活动时的鼠标坐标
var warea={
  x:null,
